...
(function() {
	...
	/**
	 * Attaches resize event to a window, limiting number of event fired. Fires only when encounteres delay of 100 after series of events.
	 * 
	...
	if (document.documentElement.getBoundingClientRect) {
		...
		var getOffset = function(el) {
			...
			var top = box.top / zoom + (window.pageYOffset || docElem && docElem.scrollTop / zoom || body.scrollTop / zoom) - clientTop, left = box.left / zoom + (window.pageXOffset || docElem && docElem.scrollLeft / zoom || body.scrollLeft / zoom)
					- clientLeft;
	...
	/**
	 * Returns left, top, right and bottom properties describing the border-box, in pixels, with the top-left relative to the body
	 * 
	 * @param {Element}
	 *            el
	...
	/**
	 * Function places an absolutely positioned element on top of the specified element copying position and dimentions.
	 * 
	 * @param {Element}
	 *            from
	 * @param {Element}
	 ...
	 * @constructor
	 * @param button
	 *            An element you want convert to upload button. Tested dimentions up to 500x500px
	 * @param {Object}
